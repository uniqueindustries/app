...
# ------------------------- CONFIG / MAPPINGS -------------------------
MAIN_COST_TABLE = {
    "United Kingdom": {1: 6.7, 2: 8.3, 3: 9.9, 4: 11.4, 5: 12.9, 6: 14.4},
    "United States":  {1: 6.2, 2: 7.7, 3: 9.2, 4: 10.5, 5: 11.8, 6: 13.1},
    "Canada":         {1: 6.8, 2: 8.7, 3:10.6, 4:12.35, 5:14.1, 6:15.85},
    "Australia":      {1: 6.7, 2: 8.4, 3:10.1, 4:11.7, 5:13.3, 6:14.9},
    "New Zealand":    {1: 7.7, 2: 9.5, 3:11.2, 4:12.9, 5:14.5, 6:16.2},
    "Netherlands":    {1: 7.7, 2: 9.3, 3:10.9, 4:12.4, 5:13.9, 6:15.4},
}
...
MAIN_NAME_ALIASES = [
    "gleamont clinical strength internal deodrant",
...
if file:
    ...
    # Topline counters so you can spot omissions quickly
    ...
    for _, row in country_counts.iterrows():
        ...
        cnt = int(row["Orders"])
        subset = breakdown_df[breakdown_df["Country"] == ctry].copy()
